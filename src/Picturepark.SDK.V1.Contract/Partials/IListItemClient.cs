...
namespace Picturepark.SDK.V1.Contract
{
    public partial interface IListItemClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        Task<IEnumerable<ListItem>> CreateFromObjectAsync(object content, Func<Type, string> schemaIdGenerator = null, bool allowMissingDependencies = false, CancellationToken cancellationToken = default(CancellationToken));
